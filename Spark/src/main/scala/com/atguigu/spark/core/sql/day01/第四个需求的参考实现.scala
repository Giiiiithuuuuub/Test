...
import com.atguigu.spark.core.demandfive.UserVisitAction
...
object Test {
    def main(args: Array[String]): Unit = {
        ...
        // TODO 获取日志数据
        val rdd: RDD[String] = sc.textFile("InputTest/user_visit_action.txt")
...
//        groupRDD.takeOrdered(10)(Ordering.Tuple2[String, Iterable[UserVisitAction]].reverse)
        ...
        reduceRDD.collect.foreach{
            case ( pageid, (totaltime, count) ) => {
                println(s"""| 页面【$pageid】总访问时长${totaltime}
